...
class BBCodeParser extends TextParser
{
    ...
    public static function usable_tags()
    {
        ...
        return new ArrayList(
            array(
                ...
                new ArrayData(array(
                    "Title" => _t('BBCodeParser.IFRAME', 'iFrame'),
                    "Description" => _t('BBCodeParser.IFRAMEDESCRIPTION', 'Embed an iframe in your post'),
                    "Example" => "[iframe]https://youtu.be/x-Ff1-LKHUA[/iframe]"
                )),
                new ArrayData(array(
    ...
    public function parse()
    {
        ...
        require_once  BASE_PATH.'/silverstripe-bbcodeparser/thirdparty/HTML_BBCodeParser2/HTML/BBCodeParser2.php';
