...
class HTML_BBCodeParser2_Filter_Iframe extends HTML_BBCodeParser2_Filter
{
    ...
    */
    function _preparse()
    {
        ...
        $this->_preparsed = preg_replace(
			"!".$oe."iframe(\s?.*)".$ce."(.*)".$oe."/iframe".$ce."!Ui",
			$o."iframe=\"\$2\" alt=\"\"\$1".$c.$o."/iframe".$c,
                        $this->_text);
    }
}
